...
class CameraController: UITableViewController {
    var assets: [Asset] = []
    ...
    override func viewDidLoad() {
       ...
       /* for i in 0 ..< 6 {
            captureController.createAssetFromImage(UIImage(named: "logo")!) { asset in
...
extension CameraController: PhotoCaptureViewControllerDelegate {
    ...
    func returnAssets(_: PhotoCaptureViewController) -> [Asset] {
        return assets
    }
